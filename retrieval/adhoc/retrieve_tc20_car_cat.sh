...
#SBATCH --job-name=retrieve_tc20_car_cat
#SBATCH --nodes=1
...
python -m src.retrieve init_dict.model_type_or_dir=naver/splade-cocondenser-ensembledistil config.pretrained_no_yamlconfig=true config.index_dir=/data/lenam/corpus/car/car_splade_index config.out_dir=/data/lenam/retrieval/adhoc/tc20_car_cat.out data.Q_COLLECTION_PATH=/data/lenam/topics/cat/tc20.tsv data.EVAL_QREL_PATH=/data/lenam/qrel/qr20.json
