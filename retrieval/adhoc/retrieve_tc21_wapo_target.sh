...
#SBATCH --job-name=retrieve_tc21_wapo_target
#SBATCH --nodes=1
...
python -m src.retrieve init_dict.model_type_or_dir=naver/splade-cocondenser-ensembledistil config.pretrained_no_yamlconfig=true config.index_dir=/data/lenam/corpus/wapo/wapo_splade_index config.out_dir=/data/lenam/retrieval/adhoc/tc21_wapo_target.out data.Q_COLLECTION_PATH=/data/lenam/topics/tsv/tc21_target.tsv data.EVAL_QREL_PATH=/data/lenam/qrel/qr21.json
