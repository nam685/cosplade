...
#SBATCH --job-name=retrieve_tc20_msp_raw
#SBATCH --nodes=1
...
python -m src.retrieve init_dict.model_type_or_dir=naver/splade-cocondenser-ensembledistil config.pretrained_no_yamlconfig=true config.index_dir=/data/lenam/corpus/msp/msp_splade_index config.out_dir=/data/lenam/retrieval/adhoc/tc20_msp_raw.out data.Q_COLLECTION_PATH=/data/lenam/topics/tsv/tc20_raw.tsv data.EVAL_QREL_PATH=/data/lenam/qrel/qr20.json
