...
t22_runpath = f"/data/lenam/cvst/emb/pred_ti_t22_{seed}_1.pkl"
...
with open(t22_runpath,"rb") as f:
	t22_emb_dict = squeeze(pickle.load(f))
...
def stringify(d):
	...
	for k in d:
		dstr[str(k)] = d[k]
	return dstr
t22qc, t22qap = stringify(tokens['t22qc']), stringify(tokens['t22qap'])
...
t22_inputs = build_inputs(t22_emb_dict,t22qc,t22qap,reverse_voc)

with open(f"/data/lenam/cvst/rfml_keyword/t22_inputs{mode}.pkl","wb") as f:
	pickle.dump(t22_inputs,f,protocol=-1)
