...
with open("/data/lenam/eval/runs/rr20_8268_golden.json",'r') as f:
	rrt20_golden = json.load(f)
with open("/data/lenam/eval/runs/rr21_8268_golden.json",'r') as f:
...
config.note = f'finetune kwpQs monot5 rerank'
...
ptc_dl = DataLoader(ptc_ds, shuffle=False, batch_size=config.VAL_BATCH_SIZE, collate_fn=embed_smart_pad)
